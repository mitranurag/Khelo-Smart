...
<html>
    ...
    <div class="jumbotron text-center">
        <h3 class="display-3">Approval</h3>
    </div>
    <br>
    <div class="container">
    ...
    <thead class="thead-inverse table-dark">
       ...
       ?>
            <tr>
                ...
                <td><a href="../approve.php?accessID=<?php echo $accessID; ?>&type=student"><i class="fa fa-check"></i></td>
...
<tbody>
    <tr>
        ...
        <td><?php echo $row['contact']?></td>
        <td><?php echo $row['date']?></td>
        <td><a href="../approve.php?accessID=<?php echo $accessID; ?>&type=trainer"><i class="fa fa-check"></i></a></td>
