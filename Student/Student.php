...
<html>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-3">Student Homepage</h1>
    </div>
    <br>
     <!--1st row-->
    <div class="row">
        <div class="col-xl-4" >
          ...
          <div class="col-xl-4">
              <div class="card bg-light text-center">
                <a href="Payment.php">
                  <img class="card-img-top" src="../img/pay_icon.svg" alt="" width="100px" height="100px"></a>
                      <div class="card-body" style="color:saddlebrown;">
      ...
      <div class="row">
          <div class="col-xl-4" >
                <div class="card bg-light text-center">
                    <a href="Slot page.php">
                  <img class="card-img-top" src="../img/block_slot_icon.svg" alt="" width="100px" height="100px"></a>
                     <div class="card-body" style="color:saddlebrown;">
                        <h4 class="card-title">Slot Page</h4>
                    </div>
                </div>
             </div>
            <div class="col-xl-4">
