...
<html>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-3">Update Progress</h1>
    </div>
    <br>
    <div class="row">
        <div class="col"></div>
        ...
        <form method="POST" action="update_progress.php">
            <div class="form-group">
                ...
                <input type="text" name="student_id" id="" class="form-control" placeholder="Student ID" required><br>
                <label for=""><b>Student Name</b></label>
                <input type="text" name="student_name" id="" class="form-control" placeholder="Student Name" required><br>
                <label for=""><b>Feedback</b></label><br>
                <textarea name="feedback" id="" cols="60" rows="5" required></textarea><br><br>
                <input type="submit">
                <input type="reset">
            </div>
      </form>
