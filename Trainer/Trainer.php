...
<html>
  ...
  <body>
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color:saddlebrown ;">
    ...
    <div class="jumbotron text-center">
      <h1 class="display-3">Trainer Homepage</h1>
    </div>
    <br />
    <!--1st row-->
    <div class="row">
      <div class="col-xl-4">
        <div class="card bg-light text-center">
          <a href="Profile.php">
            <img
              class="card-img-top"
              src="../img/admin_icon.svg"
              alt=""
              width="100px"
              height="100px"
          /></a>
          <div class="card-body" style="color:teal">
      ...
      <div class="col-xl-4">
        <div class="card bg-light text-center">
          <a href="Block slots.php">
            <img
              class="card-img-top"
              src="../img/block_slot_icon.svg"
              alt=""
              width="100px"
              height="100px"
          /></a>
          <div class="card-body" style="color: teal">
            <h4 class="card-title">Block Slots</h4>
          </div>
        </div>
      </div>
      <div class="col-xl-4">
    ...
    <div class="row">
      ...
      <div class="col-xl-4">
        <div class="card bg-light text-center">
          <a href="Update Progress.php">
            <img
              class="card-img-top"
              src="../img/update_prog.svg"
              alt=""
              width="100px"
              height="100px"
          /></a>
      ...
      <div class="col-xl-4">
        <div class="card bg-light text-center">
          <a href="View slots.php">
            <img
              class="card-img-top"
              src="../img/view_slot_icon.svg"
              alt=""
              width="100px"
              height="100px"
          /></a>
          <div class="card-body" style="color: teal">
            <h4 class="card-title">View Slots</h4>
          </div>
        </div>
      </div>
    </div>
